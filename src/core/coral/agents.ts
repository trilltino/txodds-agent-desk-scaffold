...
export const fallbackCoralAgents: CoralAgentManifest[] = [
  {
    ...
    coralRole: 'buyer',
    service: 'txline',
    manifestPath: 'docs/legacy-coral-agents/worldcup-buyer-agent/coral-agent.toml',
  ...
  },
  {
    ...
    coralRole: 'seller',
    service: 'txline.edge',
    manifestPath: 'docs/legacy-coral-agents/seller-worldcup-edge/coral-agent.toml',
  ...
  },
  {
    ...
    coralRole: 'seller',
    service: 'risk.policy',
    manifestPath: 'docs/legacy-coral-agents/seller-risk-policy/coral-agent.toml',
  ...
  },
  {
    ...
    coralRole: 'seller',
    service: 'fan.card',
    manifestPath: 'docs/legacy-coral-agents/seller-fan-card/coral-agent.toml',
  ...
  },
  {
    ...
    manifestPath: 'docs/legacy-coral-agents/verifier-agent/coral-agent.toml',
  ...
  },
  {
    ...
    manifestPath: 'docs/legacy-coral-agents/settlement-arbiter-agent/coral-agent.toml',
